...
**Last updated:** July 2026 | **App version:** 2.0.7 | **Script:** `oura_to_hec_with_phi.py`
...
**GA release set:** oura_health **2.0.7** · hypnogram_viz **1.0.1** · charge_ring_viz **1.0.0** (all AppInspect Cloud-clean; install the two viz add-ons before/alongside this app — a full Splunk restart makes their custom-viz JS render).
...
tar -xzf /path/to/oura_health-2_0_7.spl
